	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="" class="navbar-brand"><img style="width: 150px" src="product_images/LOGO3.png"> </a>
			</div>
		<div  class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				...
				<li style="top:10px;left:30px;"><button class="btn btn-primary" id="search_btn">Buscar</button></li>
			</ul>
